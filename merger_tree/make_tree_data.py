...
def make_tree_data(sim_info):
    ...
    select_sub_sample = np.where(
        (sim_info.halo_data.log10_halo_mass > 10.0) &
    ...
    # Output data
    output_file = f"{sim_info.output_path}/Tree_data_" + sim_info.simulation_name + "_satellites_10_12.hdf5"
...
def add_tree_data(sim_info, input_file):
    ...
    select_sub_sample = np.where((M200c > 9.5) & (M200c <= 10.0))[0]

    output_file = sim_info.output_path+"/"+input_file+"_95_10.hdf5" 
