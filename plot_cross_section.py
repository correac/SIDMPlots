...
ax1.plot(xrange,sigma(xrange,mx,mphi,alpha),'-',lw=3,label='$m_{x}=0.15$GeV, $m_{\phi}=0.3$MeV',color='tab:orange')
...
sigma0 = 274.85*(alpha/0.01)**2*(mx/10.)*(10./mphi)**4
print(w0,sigma0)
ax1.plot(xrange,sigma(xrange,mx,mphi,alpha),'-',lw=3,label='$m_{x}=10$GeV, $m_{\phi}=0.5$MeV',color='tab:red')
...
sigma0 = 274.85*(alpha/0.01)**2*(mx/10.)*(10./mphi)**4
print(w0,sigma0)
ax1.plot(xrange,sigma(xrange,mx,mphi,alpha),'-',lw=3,label='$m_{x}=5$GeV, $m_{\phi}=0.5$MeV',color='tab:blue')
...
sigma0 = 274.85*(alpha/0.01)**2*(mx/10.)*(10./mphi)**4
print(w0,sigma0)
ax1.plot(xrange,sigma(xrange,mx,mphi,alpha),'-',lw=3,label='$m_{x}=1$GeV, $m_{\phi}=0.3$MeV',color='tab:green')
...
new_tick_locations = np.array([1,1e1,1e2,1e3,1e4])
